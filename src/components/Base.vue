            ...
            <div class="flex h-full ">
                ...
                <div class="w-1/2  justify-end items-center flex ">
                    ...
                    <div class=" space-y-1.5 w-1/2 ">
                        <img src="../assets/view/img/smiling.jpeg" alt="" class="w-16 h-4.1 rounded-2xl mx-auto">
                        <div class="w-7 h-[6px] rounded-2xl bg-green-500 mx-auto"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="h-[73%] overflow-y-auto">
            <slot></slot>
        </div>
        <div class="h-[10%] bg-sky-900  ">
            <div class="h-4  flex  items-center border-t-[0.3px] border-white">
            <div class="w-9 h-[7px] bg-sky-50 rounded-2xl mx-[65px]"></div>
        </div>
            <div class=" flex space-x-14 justify-center my-auto">
                <div class="">
                    <div class="mx-auto flex w-full justify-center">
                        <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <path
                                ...
                                stroke="white" stroke-width="2" stroke-miterlimit="5.759" stroke-linecap="round"
                    ...
                    <p class="font-segoe-ui-variable font-bold text-[13px] text-white ">Equipement</p>
                </div>
                <div class="">
                    <div class="mx-auto flex w-full justify-center">
                        <svg width="38" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
