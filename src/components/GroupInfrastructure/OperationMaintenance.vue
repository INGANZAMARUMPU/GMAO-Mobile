<template>
    <div class="w-screen h-screen">
        <div class="w-screen h-[10%] overflow-hidden flex items-center justify-center gap-[10%]">
            <button
                class="fixed top-[] left-4 w-20 h-10 bg-sky-900 shadow-xl rounded-xl flex justify-center items-center space-x-2 z-50"
            ...
            <button
                class="fixed top-[] right-4 w-25 h-10 bg-sky-900 shadow-xl rounded-xl flex justify-center items-center space-x-2 z-50"
                @click="handleNewItem">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="32" viewBox="0 0 24 24">
                    <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="1.5"
        ...
        <div class="w-screen h-[90%] flex flex-col items-center space-y-6 shadow-xl">
            <div v-for="item in items" :key="item.id"
                ...
                <div class="w-full h-[25%] flex items-center justify-center space-x-[65%]">
                ...
                <div class="w-full h-[25%] flex items-center justify-center space-x-[18%]">
