    ...
    <div class="space-y-4 my-4">
        ...
        <div class="flex gap-2 mx-3">
            ...
            <div class=" bg-sky-100 rounded-xl flex flex-col  items-center gap-2 py-2 px-5 justify-center ">
                <p class="font-poppins font-medium text-[13px] leading-none text-center text-sky-900">Infrastructures
                </p>
                <p class="font-poppins font-bold text-[20px] leading-none text-sky-900 ">2</p>
            </div>
        </div>
        ...
        <div class="flex gap-2 mx-3">
            <div class="w-30 bg-sky-100 rounded-xl flex flex-col items-center gap-2 py-2 px-2 justify-center ">
                ...
                <p class="font-poppins font-bold text-[20px] leading-none text-sky-900 ">1</p>
            </div>
            <div class="w-full sm:w-30 bg-sky-100 rounded-xl flex flex-col  items-center gap-2 py-2 px-2 justify-center ">
                <p class="font-poppins font-medium text-[13px] leading-none text-center text-sky-900">correctives
                </p>
