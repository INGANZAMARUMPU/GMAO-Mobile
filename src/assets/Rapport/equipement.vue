<template>
    <Base>
    <div class="">
        <div class="h-1/8 b flex justify-center items-center gap-15 ">
            <div class="">
                ...
                <p class="font-segoe-ui-variable font-bold text-[13px] ">Equipement</p>
            </div>
            ...
            <div class="">
                <div class="flex w-full justify-center">
                    <svg width="40" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M27.4999 40.3462H9.16662V36.6795H27.4999V40.3462ZM40.3333 7.33332L31.6524 18.2508L31.2491 18.7458L20.9274 31.9275C20.5868 32.2682 20.1823 32.5384 19.7372 32.7228C19.2921 32.9071 18.8151 33.002 18.3333 33.002C17.8515 33.002 17.3744 32.9071 16.9293 32.7228C16.4842 32.5384 16.0798 32.2682 15.7391 31.9275C15.3984 31.5868 15.1282 31.1824 14.9438 30.7373C14.7595 30.2922 14.6646 29.8151 14.6646 29.3333C14.6646 28.8515 14.7595 28.3745 14.9438 27.9294C15.1282 27.4843 15.3984 27.0798 15.7391 26.7392L40.3333 7.33332ZM4.84911 13.2623C2.20041 17.5036 1.24792 22.5875 2.18161 27.5H3.66661V25.6667C3.64838 22.0571 4.72903 18.5274 6.76495 15.5467L4.84911 13.2623ZM21.9999 3.66666C19.1961 3.66649 16.4233 4.25314 13.8597 5.38887C11.2962 6.5246 8.99876 8.18427 7.11511 10.2612L9.21245 12.76C11.7014 10.4718 14.9524 9.19101 18.3333 9.16666C21.7325 9.19 25.0002 10.4835 27.4944 12.793L34.0028 7.65599C30.5368 5.06643 26.3264 3.66704 21.9999 3.66666ZM34.5216 20.5333L34.0944 21.0595L32.7598 22.7645C32.9167 23.724 32.997 24.6944 32.9999 25.6667V27.5H41.8183C42.6881 22.9119 41.9206 18.164 39.6494 14.0837L34.5216 20.5333Z"
                            fill="#014268" />
                    </svg>
                </div>
                <p class="font-segoe-ui-variable font-bold text-[13px] ">Performance</p>
            </div>
        </div>
        <div class="h-3  flex  items-center border-b-[0.3px]">
            <div class="w-9 h-[7px] bg-sky-800 rounded-2xl mx-[52px]"></div>
        </div>
    </div>
